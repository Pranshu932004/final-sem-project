...
if( !isset($_REQUEST['msg']) ) {
	if(empty($_POST['transaction_info'])) {
	    ...
	    $i=0;
	    if (isset($_SESSION['cart_p_name']) && is_array($_SESSION['cart_p_name'])) {
	    ...
	    $i=0;
	    if (isset($_SESSION['cart_size_name']) && is_array($_SESSION['cart_size_name'])) {
	    ...
	    $i=0;
	    if (isset($_SESSION['cart_color_name']) && is_array($_SESSION['cart_color_name'])) {
	    ...
	    $i=0;
	    if (isset($_SESSION['cart_p_current_price']) && is_array($_SESSION['cart_p_current_price'])) {
	    ...
	    if (isset($arr_cart_p_name) && is_array($arr_cart_p_name)) {
	        for ($i = 1; $i <= count($arr_cart_p_name); $i++) {
	            ...
	            // Update the stock
	            if (isset($arr_p_id) && is_array($arr_p_id)) {
